...
currently provided. It describes the basic steps of running HotSpotter to
...
\begin{itemize}
    \item \textbf{Delete your preference directory.}\\
        ...
        You may also perform this action from the gui by using: \verb+Help -> Delete Global Preferences+: \\
    ...
    \item \textbf{Delete the Computed Directory}\\
        ...
        {\tt (Help \textrightarrow{} View Internal Directory)} will open
    ...
    \item (UPDATE ME!!!!!)  \textbf{Mac OSX 10.8 Gatekeeper / 10.9 Mavericks}\\
      On the latest Mac operating systems the software may not run immediately.
      ...
      fails to run, please do the following:
        \begin{enumerate}
            ...
            \item Go to the {\tt General} tab<F4>.
